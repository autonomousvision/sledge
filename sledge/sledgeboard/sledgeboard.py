...
from sledge.sledgeboard.tabs.cloud_tab import CloudTab
from sledge.sledgeboard.tabs.configuration_tab import ConfigurationTab
from sledge.sledgeboard.tabs.histogram_tab import HistogramTab
from sledge.sledgeboard.tabs.overview_tab import OverviewTab
from sledge.sledgeboard.tabs.scenario_tab import ScenarioTab
from sledge.sledgeboard.utils.utils import check_sledgeboard_file_paths, read_sledgeboard_file_paths

logger = logging.getLogger(__name__)


class SledgeBoard:
    """SledgeBoard application class."""

    def __init__(
        self,
        sledgeboard_paths: List[str],
        ...
        """
        SledgeBoard main class.
        :param sledge_paths: A list of paths to sledgeboard files.
        ...
        self._sledgeboard_paths = check_sledgeboard_file_paths(sledgeboard_paths)
        ...
        self._profiler_file_name = "sledgeboard"
    ...
    def main_page(self, doc: Document) -> None:
        ...
        self._doc.title = "SledgeBoard"
        sledgeboard_files = read_sledgeboard_file_paths(file_paths=self._sledgeboard_paths)
        experiment_file_data = ExperimentFileData(file_paths=sledgeboard_files)
