...
from sledge.sledgeboard.base.data_class import SledgeBoardFile, SimulationScenarioKey
...
class ExperimentFileData:
    ...
    file_paths: List[SledgeBoardFile]  # Experiment file path
    ...
    def update_data(self, file_paths: List[SledgeBoardFile]) -> None:
        """
        Update experiment data with a new list of sledgeboard file paths.
        :param file_paths: A list of new sledgeboard file paths.
        """
    ...
    def _get_base_path(current_path: Path, base_path: Path, sub_folder: str) -> Path:
        """
        Get valid base path.
        :param current_path: Current sledgeboard file path.
    ...
    def _update_file_path_color(self, file_paths: List[SledgeBoardFile], starting_file_path_index: int) -> None:
        """
    ...
    def _add_metric_files(self, file_paths: List[SledgeBoardFile], starting_file_path_index: int) -> None:
        """
        Add and load metric files.
        Folder hierarchy: planner_name -> scenario_type -> metric result name -> scenario_name.pkl
        :param file_paths: A list of new sledgeboard files.
        :param starting_file_path_index: Starting file path index.
        """
        for index, file_path in enumerate(file_paths):
            file_path_index = starting_file_path_index + index
    ...
    def _add_metric_aggregator_files(self, file_paths: List[SledgeBoardFile], starting_file_path_index: int) -> None:
        """
    ...
    def _add_simulation_files(self, file_paths: List[SledgeBoardFile], starting_file_path_index: int) -> None:
        """
                        ...
                        for scenario_name_path in scenario_name_paths:
                            ...
                            self.simulation_scenario_keys.append(
                                SimulationScenarioKey(
                                    sledgeboard_file_index=file_path_index,
                                    log_name=log_name,
