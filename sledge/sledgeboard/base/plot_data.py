...
from sledge.sledgeboard.style import (
            ...
            for frame_index in range(len(history.data)):
                ...
                for traffic_light in traffic_light_status:
                    ...
                    if lane_connector is not None:
                        ...
                        if isinstance(lane_connector, SledgeLane):
                            path = lane_connector.traffic_light_baseline_path.discrete_path
                        else:
    ...
    def update_plot(self, main_figure: Figure, radius: float, frame_index: int, doc: Document) -> None:
        ...
        with self.data_source_condition:
            ...
            def update_main_figure() -> None:
                ...
                # if self.init_state:
                #     main_figure.x_range.start = 0.0 - radius / 2
                #     main_figure.x_range.end = 0.0 + radius / 2
                #     main_figure.y_range.start = 0.0 - radius / 2
                #     main_figure.y_range.end = 0.0 + radius / 2
                #     self.init_state = False
                # else:
                #     x_radius = main_figure.x_range.end - main_figure.x_range.start
                #     y_radius = main_figure.y_range.end - main_figure.y_range.start
                #     main_figure.x_range.start = 0.0 - x_radius / 2
                #     main_figure.x_range.end = 0.0 + x_radius / 2
                #     main_figure.y_range.start = 0.0 - y_radius / 2
                #     main_figure.y_range.end = 0.0 + y_radius / 2
