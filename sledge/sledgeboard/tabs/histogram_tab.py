...
from sledge.sledgeboard.tabs.config.histogram_tab_config import (
...
from sledge.sledgeboard.tabs.js_code.histogram_tab_js_code import (
    HistogramTabLoadingEndJSCode,
    HistogramTabLoadingJSCode,
    HistogramTabUpdateWindowsSizeJSCode,
)
from sledge.sledgeboard.utils.sledgeboard_histogram_utils import (
