...
from sledge.sledgeboard.base.plot_data import SimulationData
from sledge.sledgeboard.base.simulation_tile import SimulationTile
from sledge.sledgeboard.style import PLOT_PALETTE, default_div_style, scenario_tab_style
...
from sledge.sledgeboard.tabs.js_code.scenario_tab_js_code import (
...
class ScenarioTab(BaseTab):
    ...
    def _render_simulations(self) -> column:
        ...
        selected_keys = [
            ...
            and key.scenario_name == self._scalar_scenario_name_select.value
            and key.sledgeboard_file_index in self._experiment_file_active_index
        ]
