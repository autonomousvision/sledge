...
class VAEAugmenter(AbstractAugmentor):
    def __init__(
        self,
        config: VAEConfig,
    ...
    def augment(
        ...
        _, frame_raster = sledge_raw_feature_processing(sledge_vector_raw, self._config)

        del features["sledge_raw"]
        features["sledge_raster"] = frame_raster
        targets["sledge_raster"] = frame_raster
