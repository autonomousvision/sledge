...
from sledge.sledgeboard.sledgeboard import SledgeBoard
...
CONFIG_PATH = os.getenv("NUPLAN_HYDRA_CONFIG_PATH", "config/sledgeboard")

if os.environ.get("NUPLAN_HYDRA_CONFIG_PATH") is not None:
    CONFIG_PATH = os.path.join("../../../../", CONFIG_PATH)

if os.path.basename(CONFIG_PATH) != "sledgeboard":
    CONFIG_PATH = os.path.join(CONFIG_PATH, "sledgeboard")
CONFIG_NAME = "default_sledgeboard"

nest_asyncio.apply()


def initialize_sledgeboard(cfg: DictConfig) -> SledgeBoard:
    """
    Sets up dependencies and instantiates a SledgeBoard object.
    :param cfg: DictConfig. Configuration that is used to run the experiment.
    :return: SledgeBoard object.
    """
    # Update and override configs for sledge board
    ...
    sledgeboard = SledgeBoard(
        profiler_path=profiler_path,
        sledgeboard_paths=cfg.simulation_path,
...
def main(cfg: DictConfig) -> None:
    ...
    :param cfg: DictConfig. Configuration that is used to run the experiment.
    """
    sledgeboard = initialize_sledgeboard(cfg)
    sledgeboard.run()
